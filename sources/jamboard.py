...
def getJamboard(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/9350573?hl=en&ref_topic=9027054
    # and GCP : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/jamboard?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for jamboard application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='jamboard',startTime=config['start'], endTime=config['end'],
