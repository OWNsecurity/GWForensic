...
def getKeep(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/10657662?hl=en
    # and GCP : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/keep?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for keep application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='keep',startTime=config['start'], endTime=config['end'],
