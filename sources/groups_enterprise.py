...
def getGroupsEnterprise(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/9667889?hl=en
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for groups enterprise application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='groups_enterprise',startTime=config['start'], endTime=config['end'],
