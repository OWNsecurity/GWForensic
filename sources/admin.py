...
def getAdmin(service, config, ipsExport):
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for admin application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='admin',startTime=config['start'], endTime=config['end'],
