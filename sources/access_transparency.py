...
def getAccessTransparency(service, config, ipsExport):
    # Official documentation : /
    # and GCP : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/access-transparency?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for access transparency application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='access_transparency',startTime=config['start'], endTime=config['end'],
