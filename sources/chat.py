...
def getChat(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/9142478?hl=en&ref_topic=9027054    
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for chat application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='chat',startTime=config['start'], endTime=config['end'],
