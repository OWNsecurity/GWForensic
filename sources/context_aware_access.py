...
def getContextAwareAccess(service, config, ipsExport):
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for context_aware_access application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='context_aware_access',startTime=config['start'], endTime=config['end'],
