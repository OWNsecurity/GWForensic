...
def getDatastudio(service, config, ipsExport):
    # Official documentation : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/data-studio?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for data studio application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='data_studio',startTime=config['start'], endTime=config['end'],
