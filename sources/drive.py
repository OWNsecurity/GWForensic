...
def getDrive(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/4579579?hl=en
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for drive application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='drive',startTime=config['start'], endTime=config['end'],
        ...
        if not activities:
            ...
            for activity in activities:
                ...
                try:
                    ...
                    currentData = {}
                    currentData['date'] = line["time"]
                    currentData['ipAddress'] = activity['ipAddress']
                    currentData['user'] = line["email"]
    ...
    #print("Liste des attributs supp dans le champ parameters: ")
