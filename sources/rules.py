...
def getRules(service, config, ipsExport):
    # Official documentation : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/rules?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for rules application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='rules',startTime=config['start'], endTime=config['end'],
