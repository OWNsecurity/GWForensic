...
def getMeet(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/9186729?hl=en  
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for meet application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='meet',startTime=config['start'], endTime=config['end'],
