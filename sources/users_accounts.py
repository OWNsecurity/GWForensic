...
def getUsersAccounts(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/4580120?hl=en
    # and GCP : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/user-accounts?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for user accounts application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='user_accounts',startTime=config['start'], endTime=config['end'],
