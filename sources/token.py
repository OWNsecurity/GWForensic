...
def getToken(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/6124308?hl=en&ref_topic=9027054    
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for token application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='token',startTime=config['start'], endTime=config['end'],
