...
def getCalendar(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/6110475?hl=en
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for calendar application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='calendar',startTime=config['start'], endTime=config['end'],
