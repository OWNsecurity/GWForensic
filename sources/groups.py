...
def getGroups(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/6270454?hl=en
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for groups application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='groups',startTime=config['start'], endTime=config['end'],
