...
def getLogin(service, config, ipsExport):
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for login application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='login',startTime=config['start'], endTime=config['end'],
