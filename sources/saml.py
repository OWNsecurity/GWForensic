...
def getSaml(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/7007375?hl=en&ref_topic=9027054
    # and GCP : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/saml?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for saml application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='saml',startTime=config['start'], endTime=config['end'],
        ...
        if not activities:
            ...
            try:
                ...
                logging.info("There is another page to get - NextPageToken : "+str(nextPage))
