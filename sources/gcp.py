...
def getGcp(service, config, ipsExport):
    # Official documentation : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/gcp?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for gcp application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='gcp',startTime=config['start'], endTime=config['end'],
