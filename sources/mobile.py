...
def getMobile(service, config, ipsExport):
    # Official documentation : https://support.google.com/a/answer/6350074?hl=en
    # and GCP : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/mobile?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for mobile application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='mobile',startTime=config['start'], endTime=config['end'],
