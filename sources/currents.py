...
def getCurrents(service, config, ipsExport):
    # Official documentation : /
    # and GCP : https://developers.google.com/admin-sdk/reports/v1/appendix/activity/gplus?hl=fr
    ...
    while True:
        ...
        # ----------------------------------------
        # Call the Admin SDK Reports API for currents application
        # ----------------------------------------
        if nextPage == False:
            results = service.activities().list(userKey=userKeyList, applicationName='gplus',startTime=config['start'], endTime=config['end'],
